		...
		<?php
			echo "<table border='5' BORDERCOLOR=#FC8C41>
									<tr>
										...
										<td><span style='color:#FC8C41 '><b>Available time</b></span></td>
										
										</tr>
									";
							$file = fopen("dbTeacher.txt", "r");
