...
<section class="header">
	<h2> Getting Query from Others </h2>
</section>
<section class="main">
		<?php
			echo "<table border='5' BORDERCOLOR=#FC8C41>
									<tr>
										...
										<td><span style='color:#FC8C41 '><b>Query</b></span></td>
										</tr>
									";
							$file = fopen("dbQuery.txt", "r");
							...
							while(!feof($file)) {
								...
								$studentData = json_decode($teacherDataString, true);
									...
									echo "<tr>
												...
												<td><span style='color:#2BD790 '>".$query."</span></td>
												";
		...
		?>
							...
							<table>
								...
								<tr>
									<td><a href="Query.php"><span style='color:#F4FF09'><h3>back</h3></span></a></td>
								</tr>
							</table>
</section>
