...
<section class="main">
							...
							while(!feof($file)) {
								...
								$studentData = json_decode($studentDataString, true);
									...
									echo "<tr>
												...
												<td><span style='color:#2BD790 '>".$gender."</span></td>
												<td><span style='color:#2BD790 '>";
												print_r($studentData['education']);
												echo "</span></td></tr>";
		...
		?>
							...
							<table>
								<tr>
									<td><a href="ssc.php"><span style='color:#F4FF09'><h3><b>ssc</b></h3></span></a></td>
									
									<td><a href="hsc.php"><span style='color:#F4FF09'><h3>hsc</h3></span></a></td>
									<td></td><td></td>
									<td><a href="bsc.php"><span style='color:#F4FF09'><h3>bsc</h3></span></a></td>
								</tr>
								<tr>
